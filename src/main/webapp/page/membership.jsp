...
<article style="width: 850px; margin: 0 10px 10px 20px">
  <h1>회원가입약관</h1>
  <p>땅땅땅 회원가입과 관련하여 필요한 사항을 규정합니다.</p>
  <ol class="table">
  ...
  <h3>제1조 (목적)</h3>
  <p>본 약관은 땅땅땅 주식회사(이하 회사)가 인터넷 사이트(https://www.ddang.kr)를 통하여 제공하는 거래 서비스 등 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
  <h3>제2조 (정의)</h3>

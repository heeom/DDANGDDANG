...
public class MyTradeListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		MyTradeListService service = new MyTradeListService();
		int listCount = service.TradeListCount(mb_id);
		
		ArrayList<ItemBean> item = service.getTradeList(mb_id, page, limit);
		...
		forward.setPath("/mypage/myTradeList.jsp");
